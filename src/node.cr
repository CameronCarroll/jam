...
#
# In jam, 'node' might be a bit of a misnomer. At the simplest, a node is a single or a multistep activity, typically with some predecessor and successor node/task.
#
# At the leaf and root nodes of the node's dependency tree lie the 'requirements' and 'goals'.
#
